...
def generate_symbol(data):
    symbol_template = '''
  (symbol "R0603F_{0}" (pin_numbers hide) (pin_names (offset 0.254) hide) (in_bom yes) (on_board yes)
    ...
    (property "ki_keywords" "Res, {0}, 1%, 100mW, R0603" (at 0 0 0) 
      (effects (font (size 1.27 1.27)) hide)
    )
...
def main():
    csv_file = 'R0603_Lib.csv'  # replace with your csv filename
    output_file = 'R0603F.kicad_sym' #Change
