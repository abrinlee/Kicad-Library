...
def generate_symbol(data):
    symbol_template = '''
  (symbol "R0201F_{0}" (pin_numbers hide) (pin_names (offset 0.254) hide) (in_bom yes) (on_board yes)
    ...
    (property "Footprint" "Resistor_SMD:R_0201_0603Metric" (at 0 0 0)
    ...
    (property "ki_keywords" "Res, {0}, 1%, 50mW, R0201" (at 0 0 0)
      (effects (font (size 1.27 1.27)) hide)
    )
...
def main():
    csv_file = 'R0201_Lib.csv'  # replace with your csv filename
    output_file = 'R0201F.kicad_sym'
