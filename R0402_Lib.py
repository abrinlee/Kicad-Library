...
def generate_symbol(data):
    symbol_template = '''
  (symbol "R0402F_{0}" (pin_numbers hide) (pin_names (offset 0.254) hide) (in_bom yes) (on_board yes)
    ...
    (property "ki_keywords" "Res, {0}, 1%, 62.5mW, R0402" (at 0 0 0) 
      (effects (font (size 1.27 1.27)) hide)
    )
...
def main():
    csv_file = 'R0402_Lib.csv'  # replace with your csv filename
    output_file = 'R0402F.kicad_sym' #Change
