...
def generate_symbol(data):
    symbol_template = '''
  (symbol "R1206F_{0}" (pin_numbers hide) (pin_names (offset 0.254) hide) (in_bom yes) (on_board yes)
    ...
    (property "Footprint" "Resistor_SMD:R_1206_3216Metric" (at 0 0 0)
    ...
    (property "Description" "{1}" (at 0 0 0)
      (effects (font (size 1.27 1.27)) hide)
    )
    (property "ki_keywords" "Res, {0}, 1%, 250mW, R1206" (at 0 0 0) 
      (effects (font (size 1.27 1.27)) hide)
    )
...
def main():
    csv_file = 'R1206_Lib.csv'  # replace with your csv filename
    output_file = 'R1206F.kicad_sym' #Change
